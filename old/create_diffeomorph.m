function morpher_M = create_diffeomorph(maxdistortion, nsteps, ncomp, imsz)
...
function [XIn, YIn] = getdiffeo(imsz,maxdistortion,nsteps,ncomp)
    ...
    %    maxdistortion - max amount of displacement of any pixel after nsteps applications of flow field 
