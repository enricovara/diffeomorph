function make_transrotation(filename, out_filepath, x, y, fps, videosize, rng_val)
...
theta_dx_dy = zeros(16,3);
theta_dx_dy(:,1) = randi([20 160], 16,1) + randi([0 1], 16,1)*180;
theta_dx_dy(:,2) = randi([-max_x,max_x], 16,1);
theta_dx_dy(:,3) = randi([-max_y,max_y], 16,1);
